		...
		<div id="content">
		  <div class="admin-card-nav-container mt-5">
			...
			<ul class="admin-card-nav">
				<li><a class="hotel-details" href="administrator?akcija=tabelaHoteli">Hoteli</a></li>
				<li><a class="users" href="administrator?akcija=tabelaKorisnici">Korisnici</a></li>
		  		<li><a class="reservations" href="administrator?akcija=tabelaRezervacije">Rezervacije</a></li>
			</ul>
		</div>			    
		</div><!-- #content -->
